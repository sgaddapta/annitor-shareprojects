        ...
        <section id="blog" className="news-section-3 fix section-padding">
            <div className="container">
                <div className="section-title-area">
                    <SectionTitle>
                        <SectionTitle.SubTitle>{t(sectionTitlesI18nData.blog.subtitle)}</SectionTitle.SubTitle>
                        <SectionTitle.Title>{t(sectionTitlesI18nData.blog.title)}</SectionTitle.Title>
                    </SectionTitle>

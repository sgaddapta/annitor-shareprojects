...
const Footer = () => {
    ...
    const contactInfo = [
        {
            icon: <SuCallMessage />,
            label: t(navigationI18nData.contact.callUs),
            value: "+34 606 690 792",
            link: "tel:+34606690792",
        },
        {
            icon: <SuEmail />,
            label: t(navigationI18nData.contact.makeQuote),
            value: "info@annitor-gr.com",
            link: "mailto:info@annitor-gr.com",
        },
        {
            icon: <SuLocation />,
            label: t(navigationI18nData.contact.location),
            value: t(navigationI18nData.contact.address),
        },
    ];
    ...
    return (
        <footer className="footer-section footer-bg">
            ...
            <div className="footer-widgets-wrapper" style={{ display: "none" }}>
                ...
                <div className="container">
                    <div className="row">
                        ...
                        <div
                            ...
                            data-delay=".7"
                        >
                            <div className="single-footer-widget style-margin" style={{ display: "none" }}>
                                <div className="widget-head">
                                    <h3>Recent Posts</h3>
                                </div>
                ...
                <div className="container">
                    <div className="footer-wrapper d-flex align-items-center justify-content-between">
                        <p className="wow slideLeft color-2" data-delay=".3">
                            {t(navigationI18nData.footer.copyright)} <Link to="index">Annitor</Link>
                        </p>
                        <ul className="footer-menu wow slideRight" data-delay=".5">
                            <li>
                                <Link to="/legal-terms">{t(navigationI18nData.footer.termsConditions)}</Link>
                            </li>
                            <li>
                                <Link to="/privacy-policy">{t(navigationI18nData.footer.privacyPolicy)}</Link>
                            </li>
                        </ul>
                    </div>
                </div>
